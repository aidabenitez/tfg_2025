...
: ${AMENT_CURRENT_PREFIX:="/wolvi/install/cam_pos_detection"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cam_pos_detection/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cam_pos_detection/environment/path.sh"
