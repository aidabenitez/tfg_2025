...
: ${AMENT_CURRENT_PREFIX:="/wolvi/install/localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/localization/environment/pythonpath.sh"
